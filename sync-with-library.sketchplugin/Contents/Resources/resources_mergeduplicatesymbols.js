...
window.LaunchMerge = function (numberOfLocalSymbols, numberOfLibrarySymbols) {
  window.postMessage("nativeLog", "WV - LaunchMerge");
...
window.GetSymbols = function () {
  ...
  setTimeout(function () {
    var message = "We're looking for matches...";
    if (globalNumberOfSymbolsInDocument > 100) message = "We're looking for matches...<br/><br/>Wow, you have " + globalNumberOfSymbolsInDocument + " symbols here (and " + globalNumberOfSymbolsInLibraries + " in linked libraries)! 🙈<br/> This may take a while... Wanna go get a coffee?";
